...
export default function CardProductoTienda({proporcional}) {
    ...
    return (
        <div style={{width: 841 / proporcional, paddingBottom: 40 / proporcional}}
            onMouseOver={() => setViewOpcions(true)} onMouseLeave={() => setViewOpcions(false)}>
            <div style={{width: 841 / proporcional, height: 841 / proporcional, background: 'rgba(95, 101, 109, 0.4)'}}/>
            <div className='position-relative' style={{width: 841 / proporcional}}>
                ...
                <div className={`position-absolute ${view_opciones ? 'top-50 animate__animated animate__bounceIn' : 'top-0 animate__animated animate__bounceOut'}`} style={{width: 841 / proporcional}}>
                    <button className='btn' style={{width: 841 / proporcional, background: '#d18e32', height: 50 / proporcional, marginTop: 10 / proporcional,
                        marginBottom: 10 / proporcional, color: 'white', fontWeight: 400, fontSize: 16 / proporcional}}
                        onClick={() => navigate ('/producto/producto')}>
                        Ver más detalles
                    </button>
                    <div style={{width: 841 / proporcional}} className='d-flex'>
                        <div className='d-flex justify-content-center' style={{width: 420.5 / proporcional}}>
