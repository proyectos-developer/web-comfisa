                ...
                <div className="carousel-inner">
                    <div className="carousel-item active" data-bs-interval="5000">
                        <div className='' style={{width: 871 / proporcional}}>
                            <img className='rounded' src={logo_norton} style={{width: 190 / proporcional, height: 143 / proporcional, marginLeft: 340.5 / proporcional,
                                marginRight: 340.5 / proporcional, marginTop: 3.5 / proporcional, marginBottom: 3.5 / proporcional}}/>
                            <img className='rounded' src={logo_briker} style={{width: 190 / proporcional, height: 143 / proporcional, marginLeft: 340.5 / proporcional,
                                marginRight: 340.5 / proporcional, marginTop: 3.5 / proporcional, marginBottom: 3.5 / proporcional}}/>
                            <img className='rounded' src={logo_asa} style={{width: 190 / proporcional, height: 143 / proporcional, marginLeft: 340.5 / proporcional,
                                marginRight: 340.5 / proporcional, marginTop: 3.5 / proporcional, marginBottom: 3.5 / proporcional}}/>
                            <img className='rounded' src={logo_aceros} style={{width: 190 / proporcional, height: 143 / proporcional, marginLeft: 340.5 / proporcional,
                                marginRight: 340.5 / proporcional, marginTop: 3.5 / proporcional, marginBottom: 3.5 / proporcional}}/>
                            <img className='rounded' src={logo_metalyck} style={{width: 190 / proporcional, height: 143 / proporcional, marginLeft: 340.5 / proporcional,
                                marginRight: 340.5 / proporcional, marginTop: 3.5 / proporcional, marginBottom: 3.5 / proporcional}}/>
                            <img className='rounded' src={logo_indura} style={{width: 190 / proporcional, height: 143 / proporcional, marginLeft: 340.5 / proporcional,
                                marginRight: 340.5 / proporcional, marginTop: 3.5 / proporcional, marginBottom: 3.5 / proporcional}}/>
                        </div>
                    </div>
                    <div className="carousel-item" data-bs-interval="5000">
                        <div className='' style={{width: 871 / proporcional}}>
                            <img className='rounded' src={logo_majestad} style={{width: 190 / proporcional, height: 143 / proporcional, marginLeft: 340.5 / proporcional,
                                marginRight: 340.5 / proporcional, marginTop: 3.5 / proporcional, marginBottom: 3.5 / proporcional}}/>
                            <img className='rounded' src={logo_inka} style={{width: 190 / proporcional, height: 143 / proporcional, marginLeft: 340.5 / proporcional,
                                marginRight: 340.5 / proporcional, marginTop: 3.5 / proporcional, marginBottom: 3.5 / proporcional}}/>
                            <img className='rounded' src={logo_unacem} style={{width: 190 / proporcional, height: 143 / proporcional, marginLeft: 340.5 / proporcional,
                                marginRight: 340.5 / proporcional, marginTop: 3.5 / proporcional, marginBottom: 3.5 / proporcional}}/>
                            <img className='rounded' src={logo_piramide} style={{width: 190 / proporcional, height: 143 / proporcional, marginLeft: 340.5 / proporcional,
                                marginRight: 340.5 / proporcional, marginTop: 3.5 / proporcional, marginBottom: 3.5 / proporcional}}/>
                            <img className='rounded' src={logo_matusita} style={{width: 190 / proporcional, height: 143 / proporcional, marginLeft: 340.5 / proporcional,
                                marginRight: 340.5 / proporcional, marginTop: 3.5 / proporcional, marginBottom: 3.5 / proporcional}}/>
                        </div>
                    </div>
                </div>
