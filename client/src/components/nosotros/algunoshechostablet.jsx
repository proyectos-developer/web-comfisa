...
export default function AlgunosHechosTablet({proporcional}) {
    ...
    return (
        <div style={{width: '100%', paddingLeft: 60 / proporcional, paddingRight: 60 / proporcional, paddingTop: 55 / proporcional, paddingBottom: 55 / proporcional}}>
            ...
            <div style={{width: 871 / proporcional, marginBottom: 50 / proporcional}}>
                <img src={nosotros_historia} style={{width: 871 / proporcional, height: 600 / proporcional, 
            ...
            <div style={{width: 871 / proporcional, marginBottom: 50 / proporcional}}>
                <img src={nosotros_tecnologia} style={{width: 871 / proporcional, height: 600 / proporcional, 
                        marginBottom: 21 / proporcional}}/>
                <p style={{fontSize: 28 / proporcional, color: '#292929', fontWeight: 500, lineHeight: `${40 / proporcional}px`, marginBottom: 0}}>
                    Moderna tecnología
                </p>
            ...
            <div style={{width: 871 / proporcional}}>
                <img src={nosotros_equipo} style={{width: 871 / proporcional, height: 600 / proporcional, 
                        marginBottom: 21 / proporcional}}/>
                <p style={{fontSize: 28 / proporcional, color: '#292929', fontWeight: 500, lineHeight: `${40 / proporcional}px`, marginBottom: 0}}>
                    Profesionales
                </p>
