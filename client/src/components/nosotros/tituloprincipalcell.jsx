    ...
    return (
        <div style={{width: '100%', background: '#f5f6f6', height: 70 / proporcional, paddingTop: 20 / proporcional, paddingBottom: 20 / proporcional,
            ...
            <div className='d-flex justify-content-between' style={{width: '100%'}}>
                <p style={{fontSize: 22 / proporcional, fontWeight: 500, color: '#292929', marginBottom: 0, cursor: 'default'}}>NOSOTROS</p>
                <div className='d-flex justify-content-end'>
                    ...
                    <p style={{fontSize: 12 / proporcional, fontWeight: 400, color: '#5f656d', marginBottom: 0, cursor: 'pointer', textDecoration: 'underline',
                            lineHeight: `${30 / proporcional}px` }}>ACERCA DE NOSOTROS</p>
                </div>
            </div>
        </div>
    )
