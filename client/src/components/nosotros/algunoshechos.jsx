    ...
    return (
        <div style={{width: '100%', paddingLeft: 350 / proporcional, paddingRight: 350 / proporcional, paddingTop: 55 / proporcional, paddingBottom: 55 / proporcional}}>
            ...
            <div className='d-flex' style={{width: 1220 / proporcional, height: 'auto'}}>
                <div style={{width: 400 / proporcional, paddingLeft: 15 / proporcional, paddingRight: 15 / proporcional}}>
                    <img src={nosotros_historia} style={{width: 370 / proporcional, height: 280 / proporcional, 
                ...
                <div style={{width: 400 / proporcional, marginLeft: 10 / proporcional, marginRight: 10 / proporcional, 
                            paddingLeft: 15 / proporcional, paddingRight: 15 / proporcional}}>
                    <img src={nosotros_tecnologia} style={{width: 370 / proporcional, height: 280 / proporcional, 
                            marginBottom: 21 / proporcional}}/>
                    <p style={{fontSize: 28 / proporcional, color: '#292929', fontWeight: 500, lineHeight: `${40 / proporcional}px`, marginBottom: 0}}>
                        Moderna tecnología
                    </p>
                ...
                <div style={{width: 400 / proporcional, paddingLeft: 15 / proporcional, paddingRight: 15 / proporcional}}>
                    <img src={nosotros_equipo} style={{width: 370 / proporcional, height: 280 / proporcional, 
                            marginBottom: 21 / proporcional}}/>
                    <p style={{fontSize: 28 / proporcional, color: '#292929', fontWeight: 500, lineHeight: `${40 / proporcional}px`, marginBottom: 0}}>
                        Profesionales
                    </p>
