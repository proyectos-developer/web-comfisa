...
export default function CardProductoInformacion({proporcional}) {
    ...
    return (
        <div style={{width: '25%', paddingLeft: 15 / proporcional, paddingRight: 15 / proporcional, paddingBottom: 40 / proporcional}}
            onMouseOver={() => setViewOpcions(true)} onMouseLeave={() => setViewOpcions(false)}>
            <div style={{width: 275 / proporcional, height: 275 / proporcional, background: 'rgba(95, 101, 109, 0.4)'}}/>
            <div className='position-relative' style={{width: 275 / proporcional}}>
                ...
                <div className={`position-absolute ${view_opciones ? 'top-50 animate__animated animate__bounceIn' : 'top-0 animate__animated animate__bounceOut'}`} style={{width: 275 / proporcional}}>
                    <button className='btn' style={{width: 275 / proporcional, background: '#d18e32', height: 50 / proporcional, marginTop: 10 / proporcional,
                    ...
                    <div style={{width: 275 / proporcional}} className='d-flex'>
