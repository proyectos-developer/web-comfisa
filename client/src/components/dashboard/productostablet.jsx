...
import soldadura from '../../assets/productos/soldadura_404.png'
import sellador from '../../assets/productos/sellador_404.png'
import pintura from '../../assets/productos/pintura_404.png'
    ...
    return (
        <div style={{background: 'white', width: '100%', paddingLeft: 60 / proporcional, paddingRight: 60 / proporcional}}>
            ...
            <div style={{background: 'white', width: 871 / proporcional, paddingTop: 57 / proporcional, paddingBottom: 57 / proporcional}}>
                ...
                <div className='d-flex' style={{width: 871 / proporcional, marginBottom: 34 / proporcional, height: 'auto'}}>
                    <CardProveedorTablet proporcional={proporcional} titulo={lista_proveedores[12].titulo} subtitulo={lista_proveedores[12].subtitulo} descripcion={lista_proveedores[12].descripcion}  icono={lista_proveedores[12].icono} logo={lista_proveedores[12].logo}/>
                </div>
            </div>
        </div>
    )
