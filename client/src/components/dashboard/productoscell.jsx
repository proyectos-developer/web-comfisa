...
import soldadura from '../../assets/productos/soldadura_427.png'
import sellador from '../../assets/productos/sellador_427.png'
import pintura from '../../assets/productos/pintura_427.png'
    ...
    return (
        <div style={{background: 'white', width: '100%', paddingLeft: 20 / proporcional, paddingRight: 20 / proporcional}}>
            ...
            <div style={{background: 'white', width: 499 / proporcional, paddingTop: 57 / proporcional, paddingBottom: 57 / proporcional}}>
                ...
                <CardProveedorCell proporcional={proporcional} titulo={lista_proveedores[12].titulo} subtitulo={lista_proveedores[12].subtitulo} descripcion={lista_proveedores[12].descripcion}  icono={lista_proveedores[12].icono} logo={lista_proveedores[12].logo}/>
            </div>
        </div>
    )
}